...
![Nucleo Board](/public/assets/embedded-rust-from-zero-to-blink/nucleo.jpeg)
...
![STM32 Memory](/public/assets/embedded-rust-from-zero-to-blink/memory.png)
...
![GPIO REGISTER](/public/assets/embedded-rust-from-zero-to-blink/gpio_register.png)

That mode is defined by the following bit's:

![GPIO MODER](/public/assets/embedded-rust-from-zero-to-blink/gpio_config.png)

And lastly the type of output is defined here:

![GPIO OTYPER](/public/assets/embedded-rust-from-zero-to-blink/gpio_otyper.png)
