...
# Designing an embedded driver with rust on the STM32 Bluepill


![Tux, the Linux mascot](/assets/embedded-driver-in-rust/Background.jpg)

So I've recently been using rust for around the last few month's and I've really been enjoying it. A lot of my day to day work consists of writing device drivers for various hardware/software platforms. I've been really wanting to take a stab at writing these in rust, since most of the time i am using C/C++.  
